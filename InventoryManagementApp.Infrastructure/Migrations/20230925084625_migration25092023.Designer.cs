...
namespace InventoryManagementApp.Infrastructure.Migrations
{
    ...
    [Migration("20230925084625_migration25092023")]
    partial class migration25092023
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("InventoryManagementApp.Domain.Entities.Concrete.Batch", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 9, 25, 11, 46, 24, 940, DateTimeKind.Local).AddTicks(209));
            ...
            modelBuilder.Entity("InventoryManagementApp.Domain.Entities.Concrete.BillOfMaterial", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 25, 11, 46, 24, 942, DateTimeKind.Local).AddTicks(1221));
            ...
            modelBuilder.Entity("InventoryManagementApp.Domain.Entities.Concrete.Good", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 9, 25, 11, 46, 24, 943, DateTimeKind.Local).AddTicks(3877));
