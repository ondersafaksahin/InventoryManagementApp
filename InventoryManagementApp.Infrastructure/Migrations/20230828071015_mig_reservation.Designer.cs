...
namespace InventoryManagementApp.Infrastructure.Migrations
{
    ...
    [Migration("20230828071015_mig_reservation")]
            ...
            modelBuilder.Entity("InventoryManagementApp.Domain.Entities.Concrete.Batch", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        ...
                        .HasDefaultValue(new DateTime(2023, 8, 28, 10, 10, 14, 546, DateTimeKind.Local).AddTicks(6007));
            ...
            modelBuilder.Entity("InventoryManagementApp.Domain.Entities.Concrete.BillOfMaterial", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 10, 10, 14, 557, DateTimeKind.Local).AddTicks(7263));
            ...
            modelBuilder.Entity("InventoryManagementApp.Domain.Entities.Concrete.Good", b =>
                {
                    ...
                    b.Property<DateTime?>("CreatedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2023, 8, 28, 10, 10, 14, 559, DateTimeKind.Local).AddTicks(7193));
